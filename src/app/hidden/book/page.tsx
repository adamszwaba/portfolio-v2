export default function Book() {
  return (
    <main>
      <h1> 0</h1>
      <p>
        Pomarańczowe plamy lamp sodowych na Jesionowej mieszały się w kalejdoskopie załzawionych
        oczu z czerwienią i bielą świateł samochodowych. Łzy, jeszcze przed chwilą ciepłe,
        wyrzeźbiły palące chłodem kanały na policzkach. Do mieszkania Michała, bezpiecznej przystani
        w szaleństwie Tego Pierdolonego Nowego Roku, zostało mu tylko parę kroków.
      </p>
      <p>
        Prawa ręka, zmarznięta od trzymania telefonu, tkwiła w ciepłym uścisku lewej, trochę tylko
        cierpiącej od zasilania płuc w kolejne hausty Marlboro Goldów. Nerwowo obracał na palcu
        ślubną obrączkę.
      </p>
      ...
      <p>
        ...
        nadmiernie skorych do uczczenia sprawy kamradów, którzy stawili się na niezapowiedzianą i
      ...
      <p>
        ...
        <p>
          -Teraz, kiedy wróciłeś, możesz z nami zamieszkać, tylko pod jednym warunkiem: praca albo
          nauka.
        </p>
        <p>- Dobrze, mamo.</p>{' '}
        <p>
          Andrzej uśmiechnął się pod nosem, pozwolił aby ten wyraz matczynej troski pozostał bez
          większej odpowiedzi, bowiem sam ten gest był w istocie zbędny - już tego samego dnia
